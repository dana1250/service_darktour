...
<html>
	<head>
		...
		<script>
	    function idDelete(delReview){
	       location.href = "deleteReview.jsp?REVIEW_NUM=" + delReview;   //get방식으로 삭제할아이디를 넘김     
	    }
		</script>
	</head>
	<body>	
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">				
					<jsp:useBean id="dao" class="darktour.JDBC_reviewDAO" />
				    <%
				    ArrayList<ReviewVO> list = dao.getReviewlist();
				    %>
					<h2>Review List</h2>
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
			        ...
			        <tr>
			            ...
			            <td><%=vo.getUSER_ID() %></td>
			            <td><%=vo.getREVIEW_CONTENT() %></td>
			            <td><input type="button" value="삭제" onclick="idDelete('<%=vo.getREVIEW_NUM() %>');"></td>
			        </tr>				               
				    <%
				    }
				     %>
