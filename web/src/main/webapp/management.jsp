...
<html>
	<head>
	    ...
	    function idDelete(delID){
	       location.href = "deleteUser.jsp?USER_ID=" + delID;   //get방식으로 삭제할아이디를 넘김     
	    }
		</script>
	</head>
	<body>	
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">				
					<jsp:useBean id="dao" class="darktour.JDBC_memberDAO2" />
				    <%
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						...
						<th style="background-color: #eeeeee; text-align: center;">관심유적지</th>
				...
				<tbody>
			        ...
			        <tr>
			            <td><%=vo.getNAME() %></td>
			            <td><%=vo.getUSER_ID() %></td>
			            <td><%=vo.getUSER_PWD() %></td>
			            <td><%=vo.getFAVORITE_HIS() %></td>
			            <td><input type="button" value="삭제" onclick="idDelete('<%=vo.getUSER_ID() %>');"></td>
			        </tr>				               
				    <%
				    }
				     %>
